...
namespace Nop.Plugin.ExternalAuth.Google.Controllers
{
    public class ExternalAuthGoogleController : BasePluginController
    {
        ...
        {
            var model = new ExternalAuthenticationSettings();
            model.AutoRegisterEnabled = _externalAuthenticationSettings.AutoRegisterEnabled;
            return View("~/Plugins/ExternalAuth.Google/Views/ExternalAuthGoogle/PublicInfo.cshtml", model);
        }
